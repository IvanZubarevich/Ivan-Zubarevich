...
public class PacMan extends Moving{
    ...
    public PacMan(Maze maze, int x, int y) {
        ...
        this.x = x;
        this.y = y;
        Image defaultImage = new Image("file:src/resource/left1.png" );
        try {

            this.images = new Image[]{defaultImage, new Image("file:src/resource/left2.png"), defaultImage, new Image("file:src/resource/round.png")};
