...
public final class Data {
    ...
    static {
        ...
        try {
            PACMAN_IMAGE = new Image("file:src/resource/left1.png");
            PACKMAN_FONT_TITLE = Font.loadFont("file:src/resource/PacFont.ttf", 75.0D);
            PACKMAN_FONT_OPTIONS = Font.loadFont("file:src/resource/PacFont.ttf", 20.0D);
            PACKMAN_FONT_MENU = Font.loadFont("file:src/resource/PacFont.ttf", 30.0D);
            PACKMAN_FONT_MESSAGE = Font.loadFont("file:src/resource/PacFont.ttf", 50.0D);
